...
import { EncyptionService } from '../data/encryption.service';
...
export class HttpService {
  ...
  constructor(private http : HttpClient, private encryption : EncyptionService) {
  ...
  returnCorrectDataFormat(data : any)   {
    console.log("data before encr : ", data);
    if(!this.isEnc)
      return data;
